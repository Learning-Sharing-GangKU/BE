...
public class GatheringService {
    ...
    public GatheringListResponseDto getGatheringList(
        ...
        Page<Gathering> gatheringPage =
                switch (sortType) {
                    case POPULAR ->
                            (category == null)
                                    ? gatheringRepository.findPopularGatherings(
                                            pageable) // 있으면 같이 분리 추천
    ...
    public GatheringListResponseDto getRecommendedGatherings(Long userId, int page, int size) {
        ...
        List<Long> recommendedIds =
                (aiRecommendResponseDto == null || aiRecommendResponseDto.getItems() == null)
                        ? List.of()
    ...
    public GatheringListResponseDto getUserGatherings(
        ...
        String sortedByForMeta =
                role.equals("host") ? "createdAt,desc,id,desc" : "joinedAt,desc,id,desc";
