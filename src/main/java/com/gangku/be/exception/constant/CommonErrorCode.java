...
public enum CommonErrorCode implements ErrorCode {
    ...
    AI_VALIDATION_ERROR(
            "AI_VALIDATION_ERROR", "AI와의 데이터 형식과 맞지 않습니다.", HttpStatus.BAD_REQUEST.value()),
    AI_TIMEOUT_ERROR("AI_TIMEOUT_ERROR", "AI 서버와의 통신이 원활하게 이루어지지 않았습니다.", HttpStatus.GATEWAY_TIMEOUT.value()),
    AI_SERVICE_ERROR(
